        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Detail Data User Admin</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Detail Data User Admin</h3>
                                ...
                                <div class="card-body table-responsive p-0" style="height: 130px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detaildatauseradmin["id_admin"]; ?></td>
                                                <td><?= $detaildatauseradmin["nama"]; ?></td>
                                                <td><?= $detaildatauseradmin["alamat"]; ?></td>
                                                <td><?= $detaildatauseradmin["jenis_kelamin"]; ?></td>
                                                <td><?= $detaildatauseradmin["tempat_lahir"]; ?></td>
                                                <td><?= $detaildatauseradmin["tanggal_lahir"]; ?></td>
                                                <td><?= $detaildatauseradmin["no_telepon"]; ?></td>
                                                <td><?= $detaildatauseradmin["email"]; ?></td>
                                                <td><?= $detaildatauseradmin["password2"]; ?></td>
                                                <td><?= $detaildatauseradmin["role_id"]; ?></td>
                                                <td><?= $detaildatauseradmin["is_active"]; ?></td>
                                                <td><?= $detaildatauseradmin["date_created"]; ?></td>
                                                <td><img src="<?= base_url('assets/profile/' . $detaildatauseradmin["image"]); ?>" alt="" height="70px;"></td>
                                            </tr>
