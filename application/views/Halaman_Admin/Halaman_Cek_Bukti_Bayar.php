        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <?php if ($this->session->flashdata("berhasil")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        Pesanan <strong><?= $this->session->flashdata("berhasil") ?>. Di Proses
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Cek Bukti Bayar</h1>
                        </div><!-- /.col -->
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <?php
                            if ($cekbayar["metode_pembayaran"] == 'transfer_bank') {
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <td>' . $cekbayar["atas_nama"] . '</td>
                                                    <td>' . $cekbayar["nama_bank"] . '</td>
                                                    <td>' . $cekbayar["no_rek"] . '</td>';
                                if ($cekbayar["status_bayar"] == 1) {
                                    echo '<td><span class="badge text-bg-primary">Sudah Bayar</span></td>';
                                }
                                echo '<td>Rp. ' . number_format($cekbayar["total_bayar"], '0', ',', '.') . '</td>
                                                    <td><img src="' . base_url('assets/bukti_bayar/' . $cekbayar["bukti_bayar"]) . '" height="150px"></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>';

                                if ($cekbayar["status_order"] != 1) {
                                    echo '<div class="card-footer">
                                        <a href="' . base_url() . 'Halaman_Admin/SudahDiProses/' . $cekbayar["id_transaksi"] . '" type="submit" class="btn btn-primary btn-sm"><i class="fa fa-paper-plane" aria-hidden="true"></i> Proses</a>
                                    </div>';
                                } else {
                                    if ($cekbayar["status_order"] == 1) {
                                        echo '<div class="card-footer">
                                ...
                                if ($cekbayar["metode_pembayaran"] == 'cod') {
                                        ...
                                        <div class="table-responsive">
                                            <table class="table">
                                                <tr>
                                                    <th>Nama Penerima</th>
                                                    <th>Total Bayar</th>
                                                    <th class="d-flex justify-content-center">Metode Pembayaran</th>
                                                </tr>
                                                <tr>
                                                    <td>' . $cekbayar["nama_penerima"] . '</td>';
                                    echo '<td>Rp. ' . number_format($cekbayar["total_bayar"], '0', ',', '.') . '</td>
                                                <td class="d-flex justify-content-center"><span class="badge text-bg-primary">' . $cekbayar["metode_pembayaran"] . '</span></td>
                                                </tr>
                                            </table>
                                        </div>
                                    </div>';
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                ?>
                                                <td>Rp. <?= number_format($cekbayar["total_bayar"], '0', ',', '.'); ?></td>
                                                <td><img src="<?= base_url('assets/bukti_bayar/' . $cekbayar["bukti_bayar"]); ?>" height="150px"></td>
                                            </tr>
                                        </table>
                                    </div>
