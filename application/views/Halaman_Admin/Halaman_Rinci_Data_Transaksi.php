    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata("rinci")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        Data Rinci Transaksi Berhasil <strong><?= $this->session->flashdata("rinci") ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data Rinci Transaksi</h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data Rinci Transaksi</h3>

                                    <div class="card-tools">
                                        <form action="<?= base_url(); ?>Halaman_Admin/DataRinciTransaksi" method="post">
                                ...
                                <div class="card-body table-responsive p-0" style="height: 500px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <?php $no = 1 ?>
                                        <tbody>
                                            <?php foreach ($datarincitransaksi as $dtrctri) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $dtrctri["no_order"]; ?></td>
                                                    <td><?= $dtrctri["id_barang"]; ?></td>
                                                    <td><img src="<?= base_url('public/image/fotoproduk/' . $dtrctri["gambar"]); ?>" alt="" height="90px;"></td>
                                                    <td>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/HapusRinciTransaksi/<?= $dtrctri["id_rinci"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/DetailRinciTransaksi/<?= $dtrctri["id_rinci"]; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/EditRinciTransaksi/<?= $dtrctri["id_rinci"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
