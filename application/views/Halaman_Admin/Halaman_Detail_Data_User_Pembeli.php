        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Detail Data User Pembeli</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Detail Data User Pembeli</h3>
                                ...
                                <div class="card-body table-responsive p-0" style="height: 130px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detailuserpembeli["id_pembeli"]; ?></td>
                                                <td><?= $detailuserpembeli["nama"]; ?></td>
                                                <td><?= $detailuserpembeli["alamat"]; ?></td>
                                                <td><?= $detailuserpembeli["jenis_kelamin"]; ?></td>
                                                <td><?= $detailuserpembeli["tempat_lahir"]; ?></td>
                                                <td><?= $detailuserpembeli["tanggal_lahir"]; ?></td>
                                                <td><?= $detailuserpembeli["no_telepon"]; ?></td>
                                                <td><?= $detailuserpembeli["email"]; ?></td>
                                                <td><?= $detailuserpembeli["password"]; ?></td>
                                                <td><?= $detailuserpembeli["role_id"]; ?></td>
                                                <td><?= $detailuserpembeli["is_active"]; ?></td>
                                                <td><?= $detailuserpembeli["date_created"]; ?></td>
                                                <td><img src="<?= base_url('assets/profile/' . $detailuserpembeli["image"]); ?>" alt="" height="70px;"></td>
                                            </tr>
