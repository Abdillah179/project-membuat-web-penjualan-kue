        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <?php if ($this->session->flashdata("transaksi")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        Data Transaksi Berhasil <strong><?= $this->session->flashdata("transaksi"); ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <?php if ($this->session->flashdata("datauserpembeli")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("datauserpembeli"); ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <?php if ($this->session->flashdata("datauseradminn")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("datauseradminn"); ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <?php if ($this->session->flashdata("editdataadmin")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("editdataadmin"); ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <form action="<?= base_url(); ?>Halaman_Admin/DataUserAdmin" method="post">
                                ...
                                <div class="card-body table-responsive p-0" style="height: 500px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <?php $no = 1 ?>
                                        <tbody>
                                            <?php foreach ($datauseradminn as $usradmn) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $usradmn["id_admin"] ?></td>
                                                    <td><?= $usradmn["nama"] ?></td>
                                                    <td><?= $usradmn["alamat"] ?></td>
                                                    <td><?= $usradmn["jenis_kelamin"] ?></td>
                                                    <td>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/HapusDataUserAdmin/<?= $usradmn["id_admin"]; ?>" onclick=" return confirm('Apakah Anda Yakin Ingin Menghapus ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/DetailDataUserAdmin/<?= $usradmn["id_admin"]; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/EditDataUserAdmin/<?= $usradmn["id_admin"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
