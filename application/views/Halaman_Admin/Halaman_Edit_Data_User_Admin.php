                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="<?= base_url(); ?>Halaman_Admin/FormEditDataUserAdmin/<?= $user3["id_admin"]; ?>" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="nama">Nama</label>
                                            <input type="text" name="nama" class="form-control" id="nama" value="<?= $user3["nama"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("nama"); ?></h5>
                                        <div class="form-group">
                                            <label for="alamat">Alamat</label>
                                            <input type="text" name="alamat" class="form-control" id="alamat" value="<?= $user3["alamat"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("alamat"); ?></h5>
                                        <div class="form-group">
                                            <label for="jenis_kelamin">Jenis Kelamin</label>
                                            <input type="text" name="jenis_kelamin" class="form-control" id="jenis_kelamin" value="<?= $user3["jenis_kelamin"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("jenis_kelamin"); ?></h5>
                                        <div class="form-group">
                                            <label for="tempat_lahir">Tempat Lahir</label>
                                            <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" value="<?= $user3["tempat_lahir"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("tempat_lahir"); ?></h5>
                                        <div class="form-group">
                                            <label for="tanggal_lahir">Tanggal Lahir</label>
                                            <input type="text" name="tanggal_lahir" class="form-control" id="tanggal_lahir" value="<?= $user3["tanggal_lahir"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("tanggal_lahir"); ?></h5>
                                        <div class="form-group">
                                            <label for="no_telepon">No Telepon</label>
                                            <input type="text" name="no_telepon" class="form-control" id="no_telepon" value="<?= $user3["no_telepon"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("no_telepon"); ?></h5>
                                        <div class="form-group">
                                            <label for="email">Email</label>
                                            <input type="text" name="email" class="form-control" id="email" value="<?= $user3["email"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("email"); ?></h5>
                                        <div class="form-group">
                                            <label for="role_id">Role Id</label>
                                            <input type="text" name="role_id" class="form-control" id="role_id" value="<?= $user3["role_id"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("role_id"); ?></h5>
                                        <div class="form-group">
                                            <label for="is_active">Is Active</label>
                                            <input type="text" name="is_active" class="form-control" id="is_active" value="<?= $user3["is_active"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("is_active"); ?></h5>
                                        <div class="form-group">
                                            <label for="date_created">Date Created</label>
                                            <input type="text" name="date_created" class="form-control" id="date_created" value="<?= $user3["date_created"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("date_created"); ?></h5>
                                    </div>
                                    <!-- /.card-body -->
