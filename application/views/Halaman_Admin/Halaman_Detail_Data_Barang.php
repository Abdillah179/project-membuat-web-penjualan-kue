                                ...
                                <div class="card-body table-responsive p-0" style="height: 130px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detaildatabarang["nama_barang"]; ?></td>
                                                <td><?= $detaildatabarang["keterangan_barang"]; ?></td>
                                                <td><?= $detaildatabarang["kategori_barang"]; ?></td>
                                                <td><?= $detaildatabarang["id_kategori"]; ?></td>
                                                <td><?= $detaildatabarang["harga_barang"]; ?></td>
                                                <td><?= $detaildatabarang["berat"]; ?></td>
                                                <td><?= $detaildatabarang["stok"]; ?></td>
                                                <td><img src="<?= base_url('public/image/fotoproduk/' . $detaildatabarang["gambar"]); ?>" height="49px"></td>
                                            </tr>
