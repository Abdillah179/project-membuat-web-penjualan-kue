        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h1 class="m-0">Edit Data Pesan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                <?php if ($this->session->flashdata("kategori")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        Edit Kategori Barang <strong><?= $this->session->flashdata("kategori") ?>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <?php if ($this->session->flashdata("editdatapesan")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("editdatapesan") ?>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="<?= base_url(); ?>Halaman_Admin/FormEditDataPesan/<?= $editdatapesan["id"]; ?>" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="nama_pengirim">Nama Pengirim</label>
                                            <input type="text" name="nama_pengirim" class="form-control" id="nama_pengirim" value="<?= $editdatapesan["nama_pengirim"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("nama_pengirim"); ?></h5>
                                        <div class="form-group">
                                            <label for="email_pengirim">Email Pengirim</label>
                                            <input type="text" name="email_pengirim" class="form-control" id="email_pengirim" value="<?= $editdatapesan["email_pengirim"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("email_pengirim"); ?></h5>
                                        <div class="form-group">
                                            <label for="no_handphone">No Handphone</label>
                                            <input type="text" name="no_handphone" class="form-control" id="no_handphone" value="<?= $editdatapesan["no_handphone"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("no_handphone"); ?></h5>
                                        <div class="form-group">
                                            <label for="pesan">Pesan</label>
                                            <input type="text" name="pesan" class="form-control" id="pesan" value="<?= $editdatapesan["pesan"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("pesan"); ?></h5>
                                        <div class="form-group">
                                            <label for="tanggal_pengiriman">Tanggal Pengiriman</label>
                                            <input type="date" name="tanggal_pengiriman" class="form-control" id="tanggal_pengiriman" value="<?= $editdatapesan["tanggal_pengiriman"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("tanggal_pengiriman"); ?></h5>
                                    </div>
                                    <!-- /.card-body -->
