    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata("datapesan")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("datapesan"); ?>
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <form action="<?= base_url(); ?>Halaman_Admin/DataPesan" method="post">
                                ...
                                <div class="card-body table-responsive p-0" style="height: 500px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <?php $no = 1 ?>
                                        <tbody>
                                            <?php foreach ($datapesan as $dtpsn) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $dtpsn["id"] ?></td>
                                                    <td><?= $dtpsn["nama_pengirim"] ?></td>
                                                    <td><?= $dtpsn["email_pengirim"] ?></td>
                                                    <td><?= $dtpsn["no_handphone"] ?></td>
                                                    <td>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/HapusDataPesan/<?= $dtpsn["id"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ???')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/DetailDataPesan/<?= $dtpsn["id"]; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/EditDataPesan/<?= $dtpsn["id"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
