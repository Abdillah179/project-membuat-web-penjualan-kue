        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h1 class="m-0">Edit Rinci Transaksi</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata("editrinci")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("editrinci") ?>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Rinci Transaksi</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="<?= base_url(); ?>Halaman_Admin/FormEditRinciTransaksi/<?= $editrincitransaksi["id_rinci"]; ?>" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="nama_barang">Nama Barang</label>
                                            <input type="text" name="nama_barang" class="form-control" id="nama_barang" value="<?= $editrincitransaksi["nama_barang"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("nama_barang"); ?></h5>
                                        <div class="form-group">
                                            <label for="harga">Harga Barang</label>
                                            <input type="text" name="harga_barang" class="form-control" id="harga" value="<?= $editrincitransaksi["harga_barang"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("harga_barang"); ?></h5>
                                        <div class="form-group">
                                            <label for="berat">Berat Satuan (gr)</label>
                                            <input type="text" name="berat" class="form-control" id="berat" value="<?= $editrincitransaksi["berat"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("berat"); ?></h5>
                                        <div class="form-group">
                                            <label for="qty">QTY</label>
                                            <input type="text" name="qty" class="form-control" id="qty" value="<?= $editrincitransaksi["qty"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("qty"); ?></h5>
                                        <div class="form-group">
                                            <label for="subtotal">Subtotal</label>
                                            <input type="text" name="subtotal" class="form-control" id="subtotal" value="<?= $editrincitransaksi["subtotal"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("subtotal"); ?></h5>
                                        <div class="form-group">
                                            <label for="kategori_barang">Kategori Barang</label>
                                            <input type="text" name="kategori_barang" class="form-control" id="kategori_barang" value="<?= $editrincitransaksi["kategori_barang"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("subtotal"); ?></h5>
                                    </div>
                                    <!-- /.card-body -->
