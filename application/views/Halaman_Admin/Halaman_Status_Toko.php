                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Status Toko</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body table-responsive p-0" style="height: 100px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <?php foreach ($statustoko as $stsko) : ?>
                                                <tr>
                                                    <?php
                                                    if ($stsko["active"] == 1) {

                                                        echo '<td>TOKO SEDANG BUKA</td>';
                                                    } else {
                                                        echo '<td>TOKO SEDANG TUTUP</td>';
                                                    }

                                                    ?>
                                                    <td>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/EditStatusToko/<?= $stsko["id_toko"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
