        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Detail Data Rekening Toko</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Detail Data Rekening Toko</h3>
                                ...
                                <div class="card-body table-responsive p-0" style="height: 130px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detailrekeningtoko["id_rekening"]; ?></td>
                                                <td><?= $detailrekeningtoko["nama_bank"]; ?></td>
                                                <td><?= $detailrekeningtoko["atas_nama"]; ?></td>
                                                <td><?= $detailrekeningtoko["no_rek"]; ?></td>
                                            </tr>
