    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata("editdatauserpembeli")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("editdatauserpembeli") ?>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Data User Pembeli</h1>
                        </div><!-- /.col -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Data User Pembeli</h3>

                                    <div class="card-tools">
                                        <form action="<?= base_url(); ?>Halaman_Admin/DataUserPembeli" method="post">
                                ...
                                <div class="card-body table-responsive p-0" style="height: 500px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <?php $no = 1 ?>
                                        <tbody>
                                            <?php foreach ($userpembeli as $usrpbl) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $usrpbl["id_pembeli"] ?></td>
                                                    <td><?= $usrpbl["nama"] ?></td>
                                                    <td><?= $usrpbl["alamat"] ?></td>
                                                    <td><?= $usrpbl["jenis_kelamin"] ?></td>
                                                    <td>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/HapusDataUserPembeli/<?= $usrpbl["id_pembeli"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/DetailDataUserPembeli/<?= $usrpbl["id_pembeli"]; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
