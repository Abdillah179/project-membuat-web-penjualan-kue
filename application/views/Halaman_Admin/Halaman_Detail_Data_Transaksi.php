                                ...
                                <div class="card-body table-responsive p-0" style="height: 130px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detaildatatransaksi["id_transaksi"]; ?></td>
                                                <td><?= $detaildatatransaksi["id_pembeli"]; ?></td>
                                                <td><?= $detaildatatransaksi["no_order"]; ?></td>
                                                <td><?= $detaildatatransaksi["tgl_order"]; ?></td>
                                                <td><?= $detaildatatransaksi["nama_alamat"]; ?></td>
                                                <td><?= $detaildatatransaksi["nama_penerima"]; ?></td>
                                                <td><?= $detaildatatransaksi["no_handphone_penerima"]; ?></td>
                                                <td><?= $detaildatatransaksi["alamat_lengkap_penerima"]; ?></td>
                                                <td><?= $detaildatatransaksi["kecamatan"]; ?></td>
                                                <td><?= $detaildatatransaksi["kode_pos"]; ?></td>
                                                <td><?= $detaildatatransaksi["kota"]; ?></td>
                                                <td><?= $detaildatatransaksi["provinsi"]; ?></td>
                                                <td><?= $detaildatatransaksi["berat_total"]; ?></td>
                                                <td><?= $detaildatatransaksi["total_bayar"]; ?></td>
                                                <td><?= $detaildatatransaksi["status_bayar"]; ?></td>
                                                <td><img src="<?= base_url('assets/bukti_bayar/' . $detaildatatransaksi["bukti_bayar"]); ?>" alt="" height="60px"></td>
                                                <td><?= $detaildatatransaksi["atas_nama"]; ?></td>
                                                <td><?= $detaildatatransaksi["nama_bank"]; ?></td>
                                                <td><?= $detaildatatransaksi["no_rek"]; ?></td>
                                                <td><?= $detaildatatransaksi["status_order"]; ?></td>
                                                <td><img src="<?= base_url('assets/bukti_diterima/' . $detaildatatransaksi["bukti_diterima"]); ?>" alt="" height="60px"></td>
                                                <td><?= $detaildatatransaksi["penilaian_barang"]; ?></td>
                                            </tr>
