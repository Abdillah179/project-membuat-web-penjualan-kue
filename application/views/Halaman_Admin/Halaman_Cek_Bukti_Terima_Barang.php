        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Cek Bukti Terima Barang</h1>
                        </div><!-- /.col -->
                        ...
                        <div class="col-12">
                            <div class="card card-info">
                                <div class="card-header">
                                    <h3 class="card-title">Bukti Terima Barang</h3>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                <td><?= $cekbuktiditerima["no_order"]; ?></td>
                                                <td><?= $cekbuktiditerima["tgl_order"]; ?></td>
                                                <td><?= $cekbuktiditerima["nama_penerima"]; ?></td>
                                                <?php
                                                if ($cekbuktiditerima["status_bayar"] == 1) {

                                                    echo '<td><span class="badge text-bg-primary">Sudah Bayar</span></td>';
                                                } else {
                                                    if ($cekbuktiditerima["status_bayar"] != 1) {
                                                        echo '<td><span class="badge text-bg-danger">Belum Bayar</span></td>';
                                                    }
                                                }


                                                ?>
                                                <td>Rp. <?= number_format($cekbuktiditerima["total_bayar"], '0', ',', '.'); ?></td>
                                                <td><img src="<?= base_url('assets/bukti_diterima/' . $cekbuktiditerima["bukti_diterima"]); ?>" height="150px"></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
