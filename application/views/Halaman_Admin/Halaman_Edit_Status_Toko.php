        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h1 class="m-0">Edit Status Toko</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Status Toko</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="<?= base_url(); ?>Halaman_Admin/Prosessing/<?= $editstatustoko["id_toko"] ?>" method="post">
                                    <div class="col-7 mb-4">
                                        <label for="inputState" class="form-label mt-3">Edit Status Toko</label>
                                        <select name="active" id="inputState" class="form-select">
                                            <option value="1">BUKA</option>
                                            <option value="2">TUTUP</option>
                                        </select>
                                    </div>
                                    <h5 class="text-danger"><?= form_error("metode_pembayaran"); ?></h5>
