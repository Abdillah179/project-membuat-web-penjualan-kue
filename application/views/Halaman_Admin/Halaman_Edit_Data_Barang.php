                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_barang" class="form-control" id="nama" value="<?= $barang["nama_barang"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("nama_barang"); ?></h5>
                                        <div class="form-group">
                                            <label for="keterangan">Keterangan Barang</label>
                                            <input type="text" name="keterangan_barang" class="form-control" id="keterangan" value="<?= $barang["keterangan_barang"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("keterangan_barang"); ?></h5>
                                        <div class="form-group">
                                            <label for="kategori">Kategori Barang</label>
                                            <input type="text" name="kategori_barang" class="form-control" id="kategori" value="<?= $barang["kategori_barang"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("kategori_barang"); ?></h5>
                                        <div class="form-group">
                                            <label for="id_kategori">ID Kategori Barang</label>
                                            <input type="text" name="id_kategori" class="form-control" id="id_kategori" value="<?= $barang["id_kategori"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("id_kategori"); ?></h5>
                                        <div class="form-group">
                                            <label for="harga">Harga Barang</label>
                                            <input type="text" name="harga_barang" class="form-control" id="harga" value="<?= $barang["harga_barang"]; ?>">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="berat">Stok Barang</label>
