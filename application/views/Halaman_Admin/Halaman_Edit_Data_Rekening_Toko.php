        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-md-6">
                            <h1 class="m-0">Edit Data Rekening Toko</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
            ...
            <section class="content">
                ...
                <?php endif; ?>
                <?php if ($this->session->flashdata("editrekeningtokoo")) : ?>
                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                        <strong><?= $this->session->flashdata("editrekeningtokoo") ?>.
                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                <div class="container-fluid">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Edit Data Rekening Toko</h3>
                                </div>
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form action="<?= base_url(); ?>Halaman_Admin/FormEditDataRekeningToko/<?= $editrekeningtoko["id_rekening"]; ?>" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="nama_bank">Nama Bank</label>
                                            <input type="text" name="nama_bank" class="form-control" id="nama_bank" value="<?= $editrekeningtoko["nama_bank"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("nama_bank"); ?></h5>
                                        <div class="form-group">
                                            <label for="atas_nama">Atas Nama</label>
                                            <input type="text" name="atas_nama" class="form-control" id="atas_nama" value="<?= $editrekeningtoko["atas_nama"]; ?>">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("atas_nama"); ?></h5>
                                        <div class="form-group">
                                            <label for="no_rek">No Rek</label>
                                            <input type="text" name="no_rek" class="form-control" id="no_rek" value="<?= $editrekeningtoko["no_rek"]; ?>">
                                        </div>
