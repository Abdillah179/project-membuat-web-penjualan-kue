                                ...
                                <div class="card-body table-responsive p-0" style="height: 500px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detaildatapesan["id"] ?></td>
                                                <td><?= $detaildatapesan["nama_pengirim"] ?></td>
                                                <td><?= $detaildatapesan["email_pengirim"] ?></td>
                                                <td><?= $detaildatapesan["no_handphone"] ?></td>
                                                <td><?= $detaildatapesan["pesan"] ?></td>
                                                <td><?= $detaildatapesan["tanggal_pengiriman"] ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
