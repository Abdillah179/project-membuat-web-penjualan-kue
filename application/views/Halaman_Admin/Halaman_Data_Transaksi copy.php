        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url(); ?>Halaman_Admin/Data_Barang" class="nav-link">
                                ...
                                <tbody>
                                    <?php foreach ($datatransaksi as $dttsi) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<?= base_url(); ?>Halaman_Admin/HapusDataTransaksi/<?= $dttsi["id_transaksi"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ?')"><button type="button" class="btn btn-danger">Delete</button></a>
