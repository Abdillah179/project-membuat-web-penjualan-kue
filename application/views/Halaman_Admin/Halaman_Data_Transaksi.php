                            ...
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="card-tools">
                                        <form action="<?= base_url(); ?>Halaman_Admin/DataTransaksi" method="post">
                                ...
                                <div class="card-body table-responsive p-0" style="height: 500px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <?php $no = 1 ?>
                                        <tbody>
                                            <?php foreach ($datatransaksi as $dttsi) : ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $dttsi["id_transaksi"] ?></td>
                                                    <td><?= $dttsi["id_pembeli"] ?></td>
                                                    <td><?= $dttsi["no_order"] ?></td>
                                                    <td><?= $dttsi["tgl_order"] ?></td>
                                                    <td>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/HapusDataTransaksi/<?= $dttsi["no_order"]; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus ?')"><button type="button" class="btn btn-danger">Delete</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/DetailDataTransaksi/<?= $dttsi["id_transaksi"]; ?>"><button type="button" class="btn btn-primary">Detail</button></a>
                                                        <a href="<?= base_url(); ?>Halaman_Admin/EditDataTransaksi/<?= $dttsi["id_transaksi"]; ?>"><button type="button" class="btn btn-warning">Edit</button></a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
