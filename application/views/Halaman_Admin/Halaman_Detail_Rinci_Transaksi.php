                                ...
                                <div class="card-body table-responsive p-0" style="height: 130px;">
                                    <table class="table table-head-fixed text-nowrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><?= $no++; ?></td>
                                                <td><?= $detailrincitransaksi["id_rinci"]; ?></td>
                                                <td><?= $detailrincitransaksi["no_order"]; ?></td>
                                                <td><?= $detailrincitransaksi["id_barang"]; ?></td>
                                                <td><img src="<?= base_url('public/image/fotoproduk/' . $detailrincitransaksi["gambar"]); ?>" alt="" height="70px;"></td>
                                                <td><?= $detailrincitransaksi["nama_barang"]; ?></td>
                                                <td><?= $detailrincitransaksi["harga_barang"]; ?></td>
                                                <td><?= $detailrincitransaksi["berat"]; ?></td>
                                                <td><?= $detailrincitransaksi["qty"]; ?></td>
                                                <td><?= $detailrincitransaksi["subtotal"]; ?></td>
                                                <td><?= $detailrincitransaksi["kategori_barang"]; ?></td>
                                            </tr>
