                            ...
                            <div class="col-lg-12">
                                <?php if ($this->session->flashdata("Registrasi")) : ?>
                                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                        Registrasi <strong><?= $this->session->flashdata("Registrasi") ?> Silahkan Cek Email Anda Untuk Verifikasi</strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                <?php endif; ?>
                                <?php if ($this->session->flashdata("aktivasi")) : ?>
                                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                        Aktivasi Gagal <strong><?= $this->session->flashdata("aktivasi") ?></strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                <?php endif; ?>
                                <?php if ($this->session->flashdata("aktivasii")) : ?>
                                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                        Aktivasi Gagal <strong><?= $this->session->flashdata("aktivasii") ?></strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                <?php endif; ?>
                                <?php if ($this->session->flashdata("aktivasiii")) : ?>
                                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                        Aktivasi Gagal <strong><?= $this->session->flashdata("aktivasiii") ?></strong>
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                <?php endif; ?>
                                <?php if ($this->session->flashdata("aktivasiiii")) : ?>
                                    <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                        <strong><?= $this->session->flashdata("aktivasiiii") ?></strong> Silahkan Login
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                <?php endif; ?>
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url() ?>Login_Registrasi/RegistrasiPembeli" method="post">
                                        ...
                                        <h5 class="text-danger"><?= form_error("password") ?></h5>
                                        <div class="form-group">
                                            <input type="password" name="password2" class="form-control form-control-user" placeholder="Konfirmasi Password" value="<?= set_value("password2"); ?>">
                                        </div>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url() ?>Login_Registrasi/index">Sudah Punya Akun ? Login Sekarang</a>
                                    </div>
                                </div>
                            </div>
                        </div>
