                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <?php if ($this->session->flashdata("Loginn")) : ?>
                                        <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                            Maaf Email Yang Anda Masukkan <strong><?= $this->session->flashdata("Loginn") ?></strong>. Silahkan Aktivasi Terlebih Dahulu.
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                    <?php if ($this->session->flashdata("forgottttt")) : ?>
                                        <div class="alert alert-warning alert-dismissible fade show me-5 ms-5" role="alert" style="margin-top: 90px;">
                                            <strong><?= $this->session->flashdata("forgottttt") ?></strong>
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <form class="user" action="<?= base_url() ?>Login_Registrasi/LoginPembeli" method="post">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url(); ?>Login_Registrasi/Forgot_Password">Forgot Password?</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="<?= base_url() ?>Login_Registrasi/RegistrasiPembeli">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
