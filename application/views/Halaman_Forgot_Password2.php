                                ...
                                <div class="p-5">
                                    ...
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Change Your
                                            Password For</h1>
                                        <h5><?= $this->session->userdata("forgot_password"); ?></h5>
                                    </div>
                                    <form class="user" action="<?= base_url() ?>Login_Registrasi/ResetPassword" method="post">
                                        <div class="form-group">
                                            <input type="password" name="password" class="form-control form-control-user" id="exampleInputPassword" placeholder="Enter A New Password">
                                        </div>
                                        <h5 class="text-danger"><?= form_error("password"); ?></h5>
                                        <div class="form-group">
                                            <input type="password" name="password2" class="form-control form-control-user" id="exampleInputPassword2" placeholder="Confirm Password">
                                        </div>
